...
@com.qualcomm.robotcore.eventloop.opmode.TeleOp(name = "Duck Detection Red", group = "Test")
public class DuckDetectionRed extends OpMode {
    ...
    private void setRange(){this.detector.setRange(C1, C2, C3, RS); } //red
    //private void setRange(){this.detector.setRange(0.07, 0.28, 0.51, 0.43); } //blue
