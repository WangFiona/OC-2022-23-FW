...
@Disabled
@Autonomous(name="auto14HIGHnewaligner")
public class auto14HIGHnewaligner extends LinearOpMode {
    ...
    int notGrab = 0;
    float dumpLengthL = 122f;
    float dumpLength2L = 166f;
    float dumpLengthR = 120f;
