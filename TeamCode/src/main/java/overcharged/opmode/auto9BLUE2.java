...
@Disabled
@Autonomous(name="auto9BLUE2")
public class auto9BLUE2 extends LinearOpMode {
    ...
    public void AutoBody(WaitLinear lp, boolean Left) throws InterruptedException {
        ...
        robot.clawGrab();
        robot.hSlides.setPosition(Left? 120f : 115f);//(Left? 129f : 142f);//132
        ...
        while(System.currentTimeMillis() - startTime < (30000-parkTime) && opModeIsActive() && cLevel >= 1 && notGrab<2 && numGrabbed<5) {
            ...
            robot.alignerOut();
            robot.hSlides.setPosition(Left? 165f : 148f);//185f//(Left? 188f : 179f);//183f
            robot.turret.moveTo((Left? 74 : -78), turretPower); //-46
    ...
    public void reset90(WaitLinear lp, boolean Left, int newL, boolean wait) throws InterruptedException {
        ...
        if(Math.abs(robot.turret.getCurrentAngle()) > 88){
            ...
            robot.turret.moveTo((Left ? -resetAngle : resetAngle-5.5), turretPower); //84.5, 81.4
        }
    }
